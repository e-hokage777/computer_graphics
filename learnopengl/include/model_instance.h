...
{
public:
    ModelInstance(char *path, float numInstances, std::vector<glm::mat4> instanceTransforms)
    {
...
private:
    ...
    MeshInstance processMesh(aiMesh *mesh, const aiScene *scene)
    {
        ...
        return MeshInstance(vertices, indices, textures, this->numInstances, this->instanceTransforms);
    }
