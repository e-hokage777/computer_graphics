...
int main()
{
    ...
    Shader shader("shaders/vertex.vs", "shaders/depth-testing.fs");

    Plane plane = Plane(glm::vec3(1.0f), glm::vec3(0.0f, 1.0f, 0.0f), glm::vec3(0.0f, 0.0f, -1.0f));
    Plane plane2 = Plane(glm::vec3(1.0f), glm::vec3(1.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, -1.0f));
