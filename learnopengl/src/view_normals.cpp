...
int main()
{
    ...
    Shader shader("shaders/vertex.vs", "shaders/fragment.fs", "shaders/geometry.gs");
    Shader viewNormalsShader = Shader("shaders/view-normals.vs", "shaders/view-normals.fs", "shaders/view-normals.gs");

    Model backpack = Model("assets/backpack/backpack.obj");
    Cube cube = Cube(glm::vec3(2.0f, 1.0f, 1.0f));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        viewNormalsShader.use();
        viewNormalsShader.uniformMat4("projection", projectionMat);
        viewNormalsShader.uniformMat4("view", camera.getMatrix());
        viewNormalsShader.uniformMat4("model", modelMat);
        // backpack.Draw(viewNormalsShader);
        cube.Draw(viewNormalsShader);
